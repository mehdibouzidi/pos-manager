...
public class GlobalAuditMapper {
    public static <T extends GlobalDataPayload, E extends AbstractGlobalData> E payloadToEntity(T payload, E entity) {
    ...
    public static <E extends AbstractGlobalData, T extends GlobalDataPayload> T entityToPayload(E entity, T payload) {
